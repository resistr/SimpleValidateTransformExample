    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc()
                ...
                // Adds Fluent Validation services to the specified Microsoft.Extensions.DependencyInjection.IMvcBuilder.
                .AddFluentValidation(fv =>
                {
                    //     Registers all validators derived from AbstractValidator within the assembly containing
                    //     the specified type
                    fv.RegisterValidatorsFromAssemblyContaining<SourceExampleValidator>();

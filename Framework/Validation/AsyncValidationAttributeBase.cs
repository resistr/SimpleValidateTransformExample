...
{
    /// <summary>
    /// A custom <see cref="ValidationAttribute"/> that provides a custom validation method 
    ...
    public abstract class AsyncValidationAttributeBase : ValidationAttribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the Framework.Validation.AsyncValidationAttributeBase class.
        /// </summary>
        ...
        /// <param name="validationContext">True if the specified value is valid; otherwise, false.</param>
        /// <returns></returns>

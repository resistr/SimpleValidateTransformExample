...
namespace Framework.Transformation
{
    ...
    {
        /// <summary>
        /// The transformation doing the transform.
        /// </summary>
        ...
        public TransformationException(string errorMessage, object value, ITransform transform)
            : base(errorMessage)
        {
            Transform = transform;
            Value = value;
        ...
        /// <param name="transform">The the transformer doing the transformation.</param>
        /// <param name="innerException">The collection of inner exceptions.</param>
        public TransformationException(string errorMessage, object value, ITransform transform, Exception innerException)
            : base(errorMessage, innerException)
        {
            Transform = transform;
            Value = value;
